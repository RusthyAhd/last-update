...
class SP_AcceptedAllOrders extends StatefulWidget {
  const SP_AcceptedAllOrders({super.key});

  @override
  State<SP_AcceptedAllOrders> createState() => _SP_AcceptedAllOrdersState();
}

class _SP_AcceptedAllOrdersState extends State<SP_AcceptedAllOrders> {
  String userName = '';
  ...
  Future<void> getUserName() async {
    ...
    final name = prefs.getString('fullName') ?? 'N/A';
    setState(() {
      userName = name;
    });
  }
    ...
    return Scaffold(
        ...
        child: Column(
          children: [
            ...
            const Padding(
              ...
              child: Text('Your Accepted orders show here'),
            ),
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          //   MaterialPageRoute(
          //       builder: (context) =>
          //           SP_AcceptedOrder(order: order,)), // Navigate to accepted orders page
          // );
        },
        backgroundColor:
